						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="crudName" id="crudName" class="form-control" value="User" placeholder="" maxlength="50" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="crudTitle" class="form-label">CRUD Title: <span class="text-danger">*</span></label>
									<input type="text" name="crudTitle" id="crudTitle" value="User CRUD" class="form-control" placeholder="" maxlength="50" required>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control select2bs4 w-100" name="database" id="database" required>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control select2bs4 w-100" name="table" id="table" required disabled>
									</select>
								</div>
							</div>
							<div class="col-md-4">
